        ...
        <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-md space-y-8">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-zinc-500 text-base">Sign in to your account to continue creating.</p>
                </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between ml-1">
                                ...
                                <Link href="#" className="text-xs font-semibold text-zinc-500 hover:text-white transition-colors">
                                    Forgot password?
                                </Link>
                            </div>
                            <input
                ...
                <div className="text-center text-sm font-medium text-zinc-500">
                    ...
                    <Link href="/signup" className="text-white hover:text-zinc-300 transition-colors ml-1">
                        Sign up for free
                    </Link>
                </div>
            </div>
