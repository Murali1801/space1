        ...
        <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-md space-y-8">
                <div className="text-center">
                    ...
                    <h2 className="font-display text-3xl font-bold tracking-tight text-zinc-100">Create an account</h2>
                    <p className="mt-2 text-zinc-400">Enter your details below to create your account</p>
                </div>
                ...
                <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-6 backdrop-blur-sm space-y-6">
                    ...
                    <form onSubmit={handleSignup} className="space-y-4">
                        ...
                        <div onClick={(e) => handleSignup(e as any)}>
                ...
                <div className="text-center text-sm text-zinc-500">
                    ...
                    <Link href="/login" className="text-zinc-300 hover:text-zinc-100 font-medium transition-colors">
                        Sign in
                    </Link>
                </div>
            </div>
